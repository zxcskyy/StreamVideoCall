...
@Client.on_message(command(["song", f"song@{Woof.BOT_USERNAME}"]) & ~filters.channel)
def song(_, message):
...
@Client.on_message(command(["vsong", f"vsong@{Woof.BOT_USERNAME}"]) & filters.group & ~filters.edited)
